{
  ...
  sumologicCollector:: {
    remoteWriteConfigs+: [
      // kube state metrics
      {
        url: $._config.sumologicCollectorSvc + 'prometheus.metrics.state.statefulset',
        writeRelabelConfigs: [
          {
            action: 'keep',
      ...
      {
        url: $._config.sumologicCollectorSvc + 'prometheus.metrics.state.daemonset',
        writeRelabelConfigs: [
          {
            action: 'keep',
      ...
      {
        url: $._config.sumologicCollectorSvc + 'prometheus.metrics.state.deployment',
        writeRelabelConfigs: [
          {
            action: 'keep',
      ...
      {
        url: $._config.sumologicCollectorSvc + 'prometheus.metrics.state.node',
        writeRelabelConfigs: [
          {
            action: 'keep',
      ...
      {
        url: $._config.sumologicCollectorSvc + 'prometheus.metrics.state.pod',
        writeRelabelConfigs: [
          {
            action: 'keep',
