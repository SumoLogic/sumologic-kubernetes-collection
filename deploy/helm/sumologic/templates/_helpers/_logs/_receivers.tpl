{{/*
Generate filelog receivers configuration for specific Type of Operating System.
Available Types are "windows" and "linux"

Example usage
{{ include "logs.collector.configuration.receivers.filelog-container" (deepCopy . | merge (dict "Type" "windows" )) | nindent 2 }}
*/}}
{{- define "logs.collector.configuration.receivers.filelog-container" -}}
filelog/containers:
  exclude:
    ...
    {{- end }}
    {{- if eq .Values.debug.logs.otelwindows.stopLogsIngestion true }}
