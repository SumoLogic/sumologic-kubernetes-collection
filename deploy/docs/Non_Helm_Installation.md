...
```sh
curl -s https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/release-v0.16/deploy/kubernetes/setup-sumologic.yaml.tmpl | \
...
```bash
$ curl -LJO https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/release-v0.16/deploy/helm/prometheus-overrides.yaml
```
...
```bash
$ curl -LJO https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/release-v0.16/deploy/helm/fluent-bit-overrides.yaml
...
```bash
$ curl -LJO https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/release-v0.16/deploy/helm/falco-overrides.yaml
