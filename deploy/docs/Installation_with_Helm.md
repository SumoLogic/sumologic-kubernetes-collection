...
To install on `GKE`, use the provided override file to cutomize your configuration and uncomment the following lines in the file `values.yaml` referenced below:
