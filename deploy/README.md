...
```bash
$ cd /path/to/helm/charts/
$ curl -LJO https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/v0.9.0/deploy/helm/fluent-bit-overrides.yaml
...
```bash
$ cd /path/to/helm/charts/
$ curl -LJO https://raw.githubusercontent.com/SumoLogic/sumologic-kubernetes-collection/v0.9.0/deploy/helm/falco-overrides.yaml
```
