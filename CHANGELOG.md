...
- chore(deps): bump tailing-sidecar-operator from 0.20.4 to 0.20.5
- chore(deps): bump public.ecr.aws/sumologic/telegraf Docker tag to v1.39.0
...
- chore(deps): bump Helm release opentelemetry-operator from 0.111.0 to 0.112.0 [#4191]
