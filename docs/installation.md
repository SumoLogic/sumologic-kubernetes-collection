...
> [!NOTE] Additional configuration is necessary for [OpenShift](#installing-in-openshift-platform)
...
Please refer to [Troubleshooting document](/docs/troubleshoot-collection.md#troubleshooting-installation).
