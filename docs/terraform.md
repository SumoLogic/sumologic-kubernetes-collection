...
You can add [Processing Rules](https://https://www.sumologic.com/help/docs/send-data/collection/processing-rules) to an HTTP source via
...
The configuration snippet below configures two [fields](https://https://www.sumologic.com/help/docs/manage/fields/), (`node` and `deployment`) for the
default logs source:
