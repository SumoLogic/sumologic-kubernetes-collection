...
- [Keeping sourceCategory for merics](#keeping-sourcecategory-for-merics)
...
## Keeping sourceCategory for merics

In order to keep sourceCategory for metrics, the following configuration can be applied:
