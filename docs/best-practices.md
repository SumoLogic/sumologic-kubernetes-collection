...
[batch](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.100.0/processor/batchprocessor) and
[memory limiter](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.100.0/processor/memorylimiterprocessor). If you need to
